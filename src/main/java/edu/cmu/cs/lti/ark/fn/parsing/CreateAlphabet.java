...
import edu.cmu.cs.lti.ark.fn.identification.training.ExtractTrainingFeatures;
...
public class CreateAlphabet {
	private static final Logger logger = LoggerFactory
			.getLogger(CreateAlphabet.class);
	...
	private static void run(boolean doGenerateAlphabet,
		...
		if(doGenerateAlphabet){
			...
			logger.info("Read alphabet in "+(System.currentTimeMillis()-time) + " millis.");
		}
		...
		logger.info("Wrote events in " + (System.currentTimeMillis() - time) + " millis.");
		if(doGenerateAlphabet){
