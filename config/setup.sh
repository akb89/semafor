...
#export FRAMENET_DATA_DIR="/home/kabbach/FrameNetData/fndata-1.7"
#export JAVA_HOME_BIN="/usr/bin"
export FRAMENET_DATA_DIR="/Users/AKB/Dropbox/FrameNetData/fndata-1.7"
