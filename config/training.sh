...
export train_events="${MODEL_DIR}/cv.train.events.bin"
export arg_id_alphabet="${MODEL_DIR}/parser.conf"
export spans_file="${MODEL_DIR}/cv.train.sentences.frame.elements.spans "
export feature_cache="${MODEL_DIR}/featurecache.jobj"
