package stackedParserServer.mst;
...
import stackedParserServer.mst.io.DependencyReader;
import stackedParserServer.mst.io.DependencyWriter;
...
public class DependencyPipe {
	...
	public void printModelStats(Parameters params)
	{
		...
		System.out.println("No. Features: "+dataAlphabet.numEntries);
		...
		System.out.println("No. Stacked Features: "+num_stacked);
		System.out.println("No. Word+Feat Features: "+num_wordfeat);
		System.out.println("L1 norm of weight vector: "+norm1total);
		System.out.println("L1 norm of weight stacked subvector: "+norm1stacked);
		System.out.println("L1 norm of weight word+feat subvector: "+norm1wordfeat);
	}
