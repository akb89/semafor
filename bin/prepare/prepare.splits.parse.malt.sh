...
${JAVA_HOME_BIN}/java \
    ...
    -o ${training_sentence_splits_with_dependencies} 2> ${LOGS_DIR}/malt.log # Redirect stderr to semafor/logs/malt.log
...
${JAVA_HOME_BIN}/java \
    ...
    -o ${testing_sentence_splits_with_dependencies} 2>> ${LOGS_DIR}/malt.log # Redirect (and append) stderr to semafor/logs/malt.log
echo "Finished Malt dependency parsing"
echo