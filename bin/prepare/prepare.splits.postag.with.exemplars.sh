...
./mxpost tagger.project < ${training_tokenized_sentence_splits_with_exemplars} > ${training_postagged_sentence_splits_with_exemplars} 2>> ${LOGS_DIR}/mxpost.log # Redirect stderr to semafor/logs/mxpost.log
